...
static char btControllerAdd[18] = "00:02:72:CD:29:67"; //Belkin
...
int main(int arc, char**argv) {
	...
	l2cap_server_create(&server, &controllerAdd, 0x1001, 3, 500, &treat_buffer_default_func, &send_response_default_func);
